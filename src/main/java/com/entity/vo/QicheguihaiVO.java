...
public class QicheguihaiVO  implements Serializable {
	...
	public void setGuihaineirong(String guihaineirong) {
		this.guihaineirong = guihaineirong;
	}
	
	/**
	 * 获取：归还内容
	 */
	public String getGuihaineirong() {
		return guihaineirong;
	}
