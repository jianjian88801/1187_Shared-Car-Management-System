<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="车身颜色" prop="cheshenyanse">
          <el-input v-model="ruleForm.cheshenyanse" 
              placeholder="车身颜色" clearable  :readonly="ro.cheshenyanse"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="车身颜色" prop="cheshenyanse">
              <el-input v-model="ruleForm.cheshenyanse" 
                placeholder="车身颜色" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="座位数量" prop="zuoweishuliang">
          <el-input v-model="ruleForm.zuoweishuliang" 
              placeholder="座位数量" clearable  :readonly="ro.zuoweishuliang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="座位数量" prop="zuoweishuliang">
              <el-input v-model="ruleForm.zuoweishuliang" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="小时价格" prop="xiaoshijiage">
          <el-input v-model="ruleForm.xiaoshijiage" 
              placeholder="小时价格" clearable  :readonly="ro.xiaoshijiage"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="小时价格" prop="xiaoshijiage">
              <el-input v-model="ruleForm.xiaoshijiage" 
                placeholder="小时价格" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="投放地区" prop="toufangdiqu">
          <el-select v-model="ruleForm.toufangdiqu" placeholder="请选择投放地区">
            <el-option
                v-for="(item,index) in toufangdiquOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="投放地区" prop="toufangdiqu">
	      <el-input v-model="ruleForm.toufangdiqu"
                placeholder="投放地区" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="投放地点" prop="toufangdidian">
          <el-input v-model="ruleForm.toufangdidian" 
              placeholder="投放地点" clearable  :readonly="ro.toufangdidian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="投放地点" prop="toufangdidian">
              <el-input v-model="ruleForm.toufangdidian" 
                placeholder="投放地点" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  created() {
	this.ruleForm.toufangshijian = this.getCurDateTime()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.chepaihao = true;
          ...
          if(o=='cheshenyanse'){
            this.ruleForm.cheshenyanse = obj[o];
	    this.ro.cheshenyanse = true;
            continue;
          }
          if(o=='zuoweishuliang'){
	    ...
	    this.ro.xiaoshijiage = true;
          ...
          if(o=='toufangdiqu'){
            this.ruleForm.toufangdiqu = obj[o];
	    this.ro.toufangdiqu = true;
            continue;
          }
          if(o=='toufangdidian'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.$http({
              url: `option/toufangdiqu/diqu`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
                this.toufangdiquOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
         
            this.cheliangzhuangtaiOptions = "空闲,使用".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
        url: `qichetoufang/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `qichetoufang/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.qichetoufangCrossAddOrUpdateFlag = false;
                  this.parent.search();
