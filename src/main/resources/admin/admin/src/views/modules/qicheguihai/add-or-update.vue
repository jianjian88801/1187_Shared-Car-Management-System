    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="归还内容" prop="guihaineirong">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.guihaineirong" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.guihaineirong" label="归还内容" prop="guihaineirong">
                    <span v-html="ruleForm.guihaineirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.guihaishijian = true;
          ...
          if(o=='guihaineirong'){
            this.ruleForm.guihaineirong = obj[o];
	    this.ro.guihaineirong = true;
            continue;
          }
          if(o=='yonghuming'){
	...
	this.ruleForm.guihaineirong = this.ruleForm.guihaineirong.replace(reg,'../../../springboot2eidg/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
